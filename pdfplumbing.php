<?php
		...
		$pdf->Cell(190,10,'Tabel Asset Plumbing',0,0,'C');
...
$plumbing=mysqli_query($link,"select * from plumbing ORDER BY kode_asset ASC");
while($data = mysqli_fetch_array($plumbing)){
