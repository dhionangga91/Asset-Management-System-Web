<?php
		...
		$pdf->Cell(190,10,'Tabel Asset Electric',0,0,'C');
...
$electric=mysqli_query($link,"select * from electric ORDER BY kode_asset ASC");
while($data = mysqli_fetch_array($electric)){
