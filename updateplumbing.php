...
if(!isset($_SESSION['username'])) {
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM plumbing WHERE id='$id'";
    ...
    header("location:dashboardplumbing.php");
  }
  ...
  <div class="nav">
	...
	<div class="userinfo" style="font-family:lato"><strong>Hello !!!</strong> Welcome back <strong>
		...
		<div class="contentcrud">
		     <form id="form_plumbing" action="../UAS/edit_prosesplumbing.php" method="post" onSubmit="return validasi()">
			...
			<option value="Main Pump" <?php if($data['type'] == 'Main Pump'){ echo 'selected'; } ?>>
            Main Pump </option>
            <option value="Distribution Pump" <?php if($data['type'] == 'Distribution Pump'){ echo 'selected'; } ?>>Distribution Pump</option>
            <option value="Sump pit Pump" <?php if($data['type'] == 'Sump pit Pump'){ echo 'selected'; } ?>>Sump pit Pump</option>
			<option value="Filter Pump" <?php if($data['type'] == 'Filter Pump'){ echo 'selected'; } ?>>Filter Pump</option>
                  </select>
			</p>
	  </fieldset>
		<p>
