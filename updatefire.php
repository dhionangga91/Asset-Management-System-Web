...
<head>
<meta charset="utf-8">
<title>Update Fire System</title>
  ...
  <div class="nav">
	...
	<div class="userinfo" style="font-family:lato"><strong>Hello !!!</strong> Welcome back <strong>
		...
		<div class="contentcrud">
		     <form id="form_fire" action="../UAS/edit_prosesfire.php" method="post" onSubmit="return validasi()">
			...
			<p><label for="type" style="margin-left: 10px;">Type </label>
				...
				<option value="Detector" <?php if($data['type'] == 'Detector'){ echo 'selected'; } ?>>
                Detector </option>
                <option value="Fire Pump" <?php if($data['type'] == 'Fire Pump'){ echo 'selected'; } ?>>Fire Pump</option>
                <option value="MCFA" <?php if($data['type'] == 'MCFA'){ echo 'selected'; } ?>>
                MCFA</option>
                  </select>
			</p>
	  </fieldset>
