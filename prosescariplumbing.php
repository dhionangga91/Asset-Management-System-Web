...
if (isset($_POST['Search'])){
    ...
    $query = $koneksi->query("SELECT * FROM plumbing WHERE nama_asset LIKE '%$keyword%' OR kode_asset LIKE '%$keyword%' OR kapasitas LIKE '%$keyword%' OR type LIKE '%$keyword%'");
    ...
    if ($row==0){
     ...
     <th width="50px" bgcolor="#9F059E"><center><font color="white">No</font></center></th>
		...
		<td><center>
          <a href="updateplumbing.php?id=<?php echo $rows['id']; ?>"><img src="../UAS/assets/images.png" width="30px" height="30px"></img> </a> 
          </center></td>';	
        </tr>
<?php
      }
...
?>
			<br>
			<button type="button" style="width: 60px; height: 55px; float: right; margin-right: 10px;"><a href="tambahplumbing.php" ><img src="assets/create-icon-png-9.png" width="50px" height="50px"></a></button>
