	...
	<div class="userinfo" style="font-family:lato"><strong>Hello !!!</strong> Welcome back <strong>
	 ...
	 <th width="100px" bgcolor="#9F059E"><center><font color="white">Action</font></center></th>
      ...
      while($data = mysqli_fetch_assoc($result))
      {
        ...
        echo '<td><center>
          <a href="updatefire.php?id='.$data['id'].'"><img src="../UAS/assets/images.png" width="30px" height="30px"></img> </a> 
          <a href="hapusfire.php?id='.$data['id'].'"
      ...
      ?>
			...
			<button type="button" style="width: 60px; height: 55px; float: right; margin-right: 10px"><a href="excelfire.php"><img src="assets/export.jpg" width="50px" height="50px"></a></button>
