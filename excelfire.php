...
<div class="container">
  ...
  <div class="nav">
	...
	<div class="headerkanan" ><strong>FIRE FIGHTING SYSTEM</strong></div>
		...
		<h1>TABEL ASSETS FIRE FIGHTING</h1><hr color="#930892"><br>
		<div class="contentcrud">
<?php
//memasukkan data dari file data.php
include('datafire.php');
?>
		<br>
			<button type="button" style="width: 60px; height: 55px; float: right; margin-right: 60px;"><a href="pdffire.php" ><img src="assets/adobe-acrobat-pdf-file-512.png" width="50px" height="50px"></a></button>
			<button type="button" style="width: 60px; height: 55px; float: right; margin-right: 10px;"><a href="exportfire.php" ><img src="assets/excel.jpg" width="50px" height="50px"></a></button>
