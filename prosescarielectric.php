...
if (isset($_POST['Search'])){
    ...
    $query = $koneksi->query("SELECT * FROM electric WHERE nama_asset LIKE '%$keyword%' OR kode_asset LIKE '%$keyword%' OR kapasitas LIKE '%$keyword%' OR type LIKE '%$keyword%'");
    ...
    if ($row==0){
     ...
     <th width="50px" bgcolor="#9F059E"><center><font color="white">No</font></center></th>
		...
		<td><center>
          <a href="updateelectric.php?id=<?php echo $rows['id']; ?>"><img src="../UAS/assets/images.png" width="30px" height="30px"></img> </a> 
          </center></td>';	
        </tr>
<?php
      }
