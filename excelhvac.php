...
<div class="container">
  ...
  <div class="nav">
	...
	<div class="headerkanan" ><strong>HEATING VENTILATING AIR CONDITIONING</strong></div>
		<hr color=#930892>
		<div class="userinfo" style="font-family:lato"><strong>Hello !!!</strong> Welcome back <strong><?php echo $username;?></strong></div>		<h1>TABEL ASSETS HVAC</h1><hr color="#930892"><br>
		<div class="contentcrud">
<?php
//memasukkan data dari file data.php
include('datahvac.php');
?>
		<br>
			<button type="button" style="width: 60px; height: 55px; float: right; margin-right: 60px;"><a href="pdfhvac.php" ><img src="assets/adobe-acrobat-pdf-file-512.png" width="50px" height="50px"></a></button>
			<button type="button" style="width: 60px; height: 55px; float: right; margin-right: 10px;"><a href="exporthvac.php" ><img src="assets/excel.jpg" width="50px" height="50px"></a></button>
