  ...
  <div class="nav">
	...
	<div class="userinfo" style="font-family:lato"><strong>Hello !!!</strong> Welcome back <strong>
		...
		<div class="contentcrud">
		    <form id="form_hvac" action="input_proseshvac.php" method="post" onSubmit="return validasi()">
           <fieldset class="datadiri" style="margin: 5px auto; padding: 5px; border-color: #9F059E; border-style: solid; width: 800px">
             ...
             <option value="SUPPLY FAN">Supply Fan</option>
             <option value="EXHAUST FAN">Exhaust Fan</option>
             <option value="SMOKE STOP FAN">Smoke Stop Fan</option>
                   </select>	
				</p>
		  </fieldset>
