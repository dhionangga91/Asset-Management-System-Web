  ...
  <div class="nav">
	...
	<div class="userinfo" style="font-family:lato"><strong>Hello !!!</strong> Welcome back <strong>
	 ...
	 <th width="100px" bgcolor="#9F059E"><center><font color="white">Action</font></center></th>
      ...
      $query = "SELECT * FROM plumbing ORDER BY kode_asset ASC ";
      ...
      //buat perulangan untuk element tabel dari data plumbing
      ...
      while($data = mysqli_fetch_assoc($result))
      {
        ...
        echo '<td><center>
          <a href="updateplumbing.php?id='.$data['id'].'"><img src="../UAS/assets/images.png" width="30px" height="30px"></img> </a> 
          <a href="hapusplumbing.php?id='.$data['id'].'"
      ...
      ?>
			...
			<button type="button" style="width: 60px; height: 55px; float: right; margin-right: 10px"><a href="excelplumbing.php"><img src="assets/export.jpg" width="50px" height="50px"></a></button>
